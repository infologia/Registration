  ...
  else
{
  ...
  return isValid;
      ...
      render()
      {
          ...
          return(
              ...
              <div class="row">
                  ...
                  <input type="text" className="form-control" name="bridename" value={value.bridename} onChange={inputChange('bridename')}  />
    ...
    <input type="bridenation" className="form-control" name="bridenationality" value={value.BrideNationality} onChange={inputChange('BrideNationality')}  />
    <p style={{color:"red"}}>{this.state.BrideNationalityerror}</p>
     ...
     <select  className="form-control" name="brideresidential" value={value.brideresidential} onChange={inputChange('brideresidential')} >
    ...
    <p style={{color:"red"}}>{this.state.brideresidentialerror}</p>
      ...
      <select  className="form-control" name="bridereligion" value={value.bridereligion} onChange={inputChange('bridereligion')} >
    ...
    <p style={{color:"red"}}>{this.state.bridereligionerror}</p>
      ...
      <input type="text" className="form-control" name="bridecaste" value={value.bridecaste} onChange={inputChange('bridecaste')} />
      <p style={{color:"red"}}>{this.state.bridecasteerror}</p>
                  ...
                  <input type="date" className="form-control"  onChange={this.handleChangeStartDate}  name="BrideDateofbirth" value={value.BrideDateofbirth} onChange={inputChange('BrideDateofbirth')} ></input>
...
{this.state.calage}</p>
    ...
    <input type="text" className="form-control" name="brideemployername" onClick={this.datecal} value={value.brideemployername} onChange={inputChange('brideemployername')} />
    ...
    <input type="text" className="form-control" name="bridedesignation" value={value.bridedesignation} onChange={inputChange('bridedesignation')}  />
    ...
    <div class="row">
     <div class="col-md-3">
      ...
      <select  className="form-control" name="bridemaritalstatus" value={value.bridemaritalstatus} onChange={inputChange('bridemaritalstatus')}>
    ...
    <input type="mobile" className="form-control" name="bridemobilenumber" value={value.bridemobilenumber} onChange={inputChange('bridemobilenumber')}/>
    ...
    <input type="whatsapp" className="form-control" name="bridewhatsapp" value={value.bridewhatsapp} onChange={inputChange('bridewhatsapp')} />
    <p style={{color:"red"}}>{this.state.bridewhatsapperror}</p>
             </div>
      </div>
      <div class="col-md-3">
      <label>Email Address<span style={{color:"red"}}> *</span></label>
      <input type="text" className="form-control" name="brideemail" value={value.brideemail} onChange={inputChange('brideemail')} />
    ...
    <br></br>
     ...
     <label>Street<span style={{color:"red"}}> *</span></label>
              <input type="text" className="form-control" name="Street3" value={value.Street3} onChange={inputChange('Street3')} />
               <p style={{color:"red"}}>{this.state.Street3error}</p>
      </div>
      <div class="col-md-4"> 
      <label>Village<span style={{color:"red"}}> *</span></label>
       <input type="text" className="form-control" name="Village3" value={value.Village3} onChange={inputChange('Village3')} />
               <p style={{color:"red"}}>{this.state.Village3error}</p>
          </div>
          <div class="col-md-4">
     <label>Taluk<span style={{color:"red"}}> *</span></label>
     <input type="text" className="form-control" name="Taluk3" value={value.Taluk3} onChange={inputChange('Taluk3')}  />
    ...
    <div class="row">
      ...
      <label>District<span style={{color:"red"}}> *</span></label>
        <input type="text" className="form-control" name="District3" value={value.District3} onChange={inputChange('District3')} />
               <p style={{color:"red"}}>{this.state.District3error}</p>
      </div>
      <div class="col-md-4">
    <label>State<span style={{color:"red"}}> *</span></label>
      <input type="text" className="form-control" name="State3" value={value.State3} onChange={inputChange('State3')} />
               <p style={{color:"red"}}>{this.state.State3error}</p>
    </div>
      <div class="col-md-4">
   <label>Country<span style={{color:"red"}}> *</span></label>
     <input type="text" className="form-control" name="Country3" value={value.Country3} onChange={inputChange('Country3')}  />
               <p style={{color:"red"}}>{this.state.Country3error}</p>
       </div>
       <div class="col-md-4">
 <label>Pincode<span style={{color:"red"}}> *</span></label>
      <input type="text" className="form-control" name="Pincode3" value={value.Pincode3} onChange={inputChange('Pincode3')} />
               <p style={{color:"red"}}>{this.state.Pincode3error}</p>
      </div>
      <div class="col-md-4">
        <div class="form-group">
      <label>Passport Number<span style={{color:"red"}}> *</span></label>
      <input type="text"  className="form-control" name="bridepassport" value={value.bridepassport} onChange={inputChange('bridepassport')}/>
